/*
    ...
    OpenGL loader generated by glad 0.1.24a0 on Sun Jul  1 20:04:43 2018.
    ...
    Commandline:
        --profile="core" --api="gl=3.2" --generator="c" --spec="gl" --omit-khrplatform --extensions="GL_ARB_clear_texture,GL_ARB_debug_output,GL_ARB_get_program_binary,GL_ARB_texture_storage,GL_ARB_timer_query"
    Online:
        http://glad.dav1d.de/#profile=core&language=c&specification=gl&loader=on&api=gl%3D3.2&extensions=GL_ARB_clear_texture&extensions=GL_ARB_debug_output&extensions=GL_ARB_get_program_binary&extensions=GL_ARB_texture_storage&extensions=GL_ARB_timer_query
*/
